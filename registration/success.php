...
<head>
  ...
  <title>Payment Success</title>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.4/TweenMax.min.js"></script><link rel="stylesheet" href="./style.css">
</head>
<body>
...
<div class="screen un">
            ...
            <img src="https://cdn.razorpay.com/logos/DCaiRnJ8DUf2Ja_medium.jpg" id="topIcon">
            
            <h3>SUCCESS!</h3>
            <p>Your Payment for STEPCONE 2020 is Successful.</p>
            
            <a href="../home.html"><button id="btnClick">Go To Home Page</button></a>
...
for($i=0;$i<$n;$i++)
{
	...
	$name=$_POST['name'.$i];
	echo $_POST['email'];
	$query="update event_registration set status=1 where Email='".$_POST['email']."' and Type='".$type."' and Name='".$name."'";
	if(mysql_query($query))
		echo "<tr><td>".($i+1)."</td><td>".$type."</td><td>".$name."</td></tr>";
	else
		echo mysql_error();	 
}
?>
